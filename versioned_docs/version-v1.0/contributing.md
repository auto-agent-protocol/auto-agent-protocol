...
| Path | Purpose |
|---|---|
| `spec/v1.0/schemas/` | Current (v1.0) JSON Schemas — the source of truth. Edit here. |
| `spec/v1.0/examples/` | Current (v1.0) example payloads. Edit here. |
| `spec/v1.0/skills.yaml` | Current (v1.0) skill manifest. Edit here. |
| `spec/v0.1/`, `spec/v0.2/` | Frozen v0.1 and v0.2 schemas, examples, and skills. **Do not edit — released versions are immutable.** |
| `docs/` | Docusaurus prose pages for the current version (v1.0). |
| `versioned_docs/`, `versioned_sidebars/`, `versions.json` | Frozen v0.1 and v0.2 docs snapshots, managed by `docusaurus docs:version`. **Do not hand-edit.** |
...
The following are intentionally out of scope for v1.0; pull requests adding them to v1.0 will not be accepted:
...
- gRPC binding. (AAP v1.0 requires a JSONRPC interface on every agent card; HTTP+JSON MAY be added. A2A's gRPC binding is out of scope.)
